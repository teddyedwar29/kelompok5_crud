        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left whitespace-nowrap">Pages</span>
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.author') }}"
                            class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Author</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.artikel') }}"
                            class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Artikel</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.detailArtikel') }}"
