    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <h1
                ...
                Selamat Datang Dihalaman Kelompok 5</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Ini
                Merupakan Halaman User Yang Mana User Hanya Dapat Melihat Publikasinya Saja.</p>
