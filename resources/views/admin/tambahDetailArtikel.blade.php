...
<head>
    ...
    <title>Tambah Detail Artikel</title>
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 bg-gray-50 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <form action="{{ route('admin.submitDetailArtikel') }}" class="max-w-md ml-2" method="post">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5">
                    <label for="id_author"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">id_author</label>
                    <input type="text" id="id_author" name="id_author"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="id_author" required />
                </div>
                <div class="mb-5">
                    <label for="penulis_ke" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penulis
                        Ke</label>
                    <input type="text" id="penulis_ke" name="penulis_ke"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="penulis_ke" required />
                </div>
