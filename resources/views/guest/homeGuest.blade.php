        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <a href="/login"
                ...
                <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span
                    class="text-sm font-medium">Silahkan login terlebih dahulu</span>
            ...
            <p
                ...
                Selamat Datang Dihalaman Kelompok 5</p>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                Ini Merupakan Halaman Guest Dimana Halaman Ini Hanya Dapat Membaca Publikasi Saja.</p>
